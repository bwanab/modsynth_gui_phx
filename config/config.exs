...
config :modsynth_gui_phx, ModsynthGuiPhxWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ModsynthGuiPhxWeb.ErrorHTML, json: ModsynthGuiPhxWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: ModsynthGuiPhx.PubSub,
  live_view: [signing_salt: "Ahko67uo"]
...
config :modsynth_gui_phx, ModsynthGuiPhx.Mailer, adapter: Swoosh.Adapters.Local
